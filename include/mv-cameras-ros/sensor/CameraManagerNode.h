...
#include "mv_cameras_ros/GetCameras.h"
...
namespace mv {
  ...
  protected:
    ...
    void diagnoseCameraManager(diagnostic_updater::DiagnosticStatusWrapper&
      status);
    /// Get cameras service
    bool getCameras(mv_cameras_ros::GetCamerasRequest& request,
                    mv_cameras_ros::GetCamerasResponse& response);
    /** @}
      */
    ...
    /// Get cameras service
    ros::ServiceServer _getCamerasService;
    /** @}
      */
