...
#include "mv-cameras-ros/base/Thread.h"
#include "mv-cameras-ros/base/Mutex.h"
#include "mv_cameras_ros/SetExposure.h"
#include "mv_cameras_ros/SetGain.h"
#include "mv_cameras_ros/SetFramerate.h"
#include "mv_cameras_ros/SetPixelClock.h"
#include "mv_cameras_ros/SetColorMode.h"
#include "mv_cameras_ros/SetSyncMode.h"
#include "mv_cameras_ros/SetTimestampReset.h"
#include "mv_cameras_ros/GetExposure.h"
#include "mv_cameras_ros/GetGain.h"
#include "mv_cameras_ros/GetFramerate.h"
#include "mv_cameras_ros/GetPixelClock.h"
#include "mv_cameras_ros/GetColorMode.h"
#include "mv_cameras_ros/GetSyncMode.h"
#include "mv_cameras_ros/GetTimestampReset.h"
...
namespace mv {
  ...
  protected:
    ...
    bool setExposure(mv_cameras_ros::SetExposureRequest& request,
      mv_cameras_ros::SetExposureResponse& response);
    /// Set gain service
    bool setGain(mv_cameras_ros::SetGainRequest& request,
      mv_cameras_ros::SetGainResponse& response);
    /// Set framerate service
    bool setFramerate(mv_cameras_ros::SetFramerateRequest& request,
      mv_cameras_ros::SetFramerateResponse& response);
    /// Set pixel clock service
    bool setPixelClock(mv_cameras_ros::SetPixelClockRequest& request,
      mv_cameras_ros::SetPixelClockResponse& response);
    /// Set color mode service
    bool setColorMode(mv_cameras_ros::SetColorModeRequest& request,
      mv_cameras_ros::SetColorModeResponse& response);
    /// Set synchronization mode service
    bool setSyncMode(mv_cameras_ros::SetSyncModeRequest& request,
      mv_cameras_ros::SetSyncModeResponse& response);
    /// Set timestamp reset service
    bool setTimestampReset(mv_cameras_ros::SetTimestampResetRequest& request,
      mv_cameras_ros::SetTimestampResetResponse& response);
    /// Get exposure service
    bool getExposure(mv_cameras_ros::GetExposureRequest& request,
      mv_cameras_ros::GetExposureResponse& response);
    /// Get gain service
    bool getGain(mv_cameras_ros::GetGainRequest& request,
      mv_cameras_ros::GetGainResponse& response);
    /// Get framerate service
    bool getFramerate(mv_cameras_ros::GetFramerateRequest& request,
      mv_cameras_ros::GetFramerateResponse& response);
    /// Get pixel clock service
    bool getPixelClock(mv_cameras_ros::GetPixelClockRequest& request,
      mv_cameras_ros::GetPixelClockResponse& response);
    /// Get color mode service
    bool getColorMode(mv_cameras_ros::GetColorModeRequest& request,
      mv_cameras_ros::GetColorModeResponse& response);
    /// Get synchronization mode service
    bool getSyncMode(mv_cameras_ros::GetSyncModeRequest& request,
      mv_cameras_ros::GetSyncModeResponse& response);
    /// Get timestamp reset service
    bool getTimestampReset(mv_cameras_ros::GetTimestampResetRequest& request,
      mv_cameras_ros::GetTimestampResetResponse& response);
    /** @}
      */
