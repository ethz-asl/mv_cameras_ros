...
#include "mv-cameras-ros/sensor/CameraNode.h"
...
#include "mv-cameras-ros/base/Timer.h"
#include "mv-cameras-ros/base/Timestamp.h"

#include "mv_cameras_ros/ImageSnappyMsg.h"
...
/******************************************************************************/
  ...
  CameraNode::CameraNode(const ros::NodeHandle& nodeHandle, Device* device,
    ...
    _imageSnappyPublisher =
      _nodeHandle.advertise<mv_cameras_ros::ImageSnappyMsg>(
...
/******************************************************************************/
  ...
  void CameraNode::publishImage(const ros::Time& timestamp,
    ...
    mv_cameras_ros::ImageSnappyMsgPtr imageSnappyMsg =
      boost::make_shared<mv_cameras_ros::ImageSnappyMsg>();
  ...
  bool CameraNode::setExposure(mv_cameras_ros::SetExposureRequest& request,
  ...
  bool CameraNode::setGain(mv_cameras_ros::SetGainRequest& request,
  ...
  bool CameraNode::setFramerate(mv_cameras_ros::SetFramerateRequest& request,
  ...
  bool CameraNode::setPixelClock(mv_cameras_ros::SetPixelClockRequest& request,
  ...
  bool CameraNode::setColorMode(mv_cameras_ros::SetColorModeRequest& request,
  ...
  bool CameraNode::setSyncMode(mv_cameras_ros::SetSyncModeRequest& request,
  ...
  bool CameraNode::setTimestampReset(mv_cameras_ros::SetTimestampResetRequest&
      request, mv_cameras_ros::SetTimestampResetResponse& response) {
    Mutex::ScopedLock lock(_mutex);
  ...
  bool CameraNode::getExposure(mv_cameras_ros::GetExposureRequest& request,
  ...
  bool CameraNode::getGain(mv_cameras_ros::GetGainRequest& request,
  ...
  bool CameraNode::getFramerate(mv_cameras_ros::GetFramerateRequest& request,
  ...
  bool CameraNode::getPixelClock(mv_cameras_ros::GetPixelClockRequest& request,
  ...
  bool CameraNode::getColorMode(mv_cameras_ros::GetColorModeRequest& request,
  ...
  bool CameraNode::getSyncMode(mv_cameras_ros::GetSyncModeRequest& request,
  ...
  bool CameraNode::getTimestampReset(mv_cameras_ros::GetTimestampResetRequest&
      request, mv_cameras_ros::GetTimestampResetResponse& response) {
    Mutex::ScopedLock lock(_mutex);
